# ============================================
# Code::Blocks + FreeGLUT Setup Script
# ============================================
...
$destinationDll = "C:\Windows\System32\freeglut.dll"

if (Test-Path $destinationDll) {
    Remove-Item $destinationDll -Force
}

Copy-Item $sourceDll $destinationDll
Write-Host "freeglut.dll installed."
...
if (Test-Path $destinationGL) {
    Remove-Item $destinationGL -Recurse -Force
}

New-Item -ItemType Directory -Path $destinationGL -Force | Out-Null
Copy-Item "$sourceGL\*" $destinationGL -Recurse
Write-Host "GL headers installed."
...
$destinationLib = "C:\Program Files\CodeBlocks\MinGW\lib\libfreeglut.a"

if (Test-Path $destinationLib) {
    Remove-Item $destinationLib -Force
}

Copy-Item $sourceLib $destinationLib
Write-Host "libfreeglut.a installed."
...
Write-Host "Sample project created."

Write-Host ""
Write-Host "========================================"
Write-Host "OpenGL setup completed successfully!"
Write-Host "Sample project:"
